...
<body style="font-family:Arial,sans-serif;color:#23201c;line-height:1.5">
    ...
    <p>A new order was submitted through the Ozghan website.</p>
    <h2>Customer</h2>
    ...
    <p>
        ...
        <strong>Materials provided:</strong> {{ $order->materials_provided ? 'Yes' : 'No' }}<br>
        <strong>Tile size:</strong> {{ $order->tile_size ?: '—' }}
    </p>
    <h2>Customer note</h2>
