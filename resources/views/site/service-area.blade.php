...
<title>Brisbane Tiling Service Areas | Ozghan.com.au</title>
...
@include('site.partials.seo', ['seoTitle' => 'Brisbane Tiling Service Areas | Ozghan.com.au', 'seoDescription' => 'Find a trusted Brisbane tiler serving Brisbane CBD and surrounding suburbs, including New Farm, Paddington, West End, Toowong and Indooroopilly.'])
...
<header class="site-header">
  <div class="container nav">
    ...
    <nav class="nav-links" aria-label="Primary">
      ...
      <a href="/service-area" data-nav="area" aria-current="page">Service Area</a>
...
<header class="page-header">
  <div class="container">
    <div class="breadcrumb">Service Area</div>
    <h1>Currently serving Brisbane, Queensland</h1>
  </div>
</header>
...
<section class="section-tight">
  <div class="container two-col">
    <div>
      ...
      <h2>Brisbane, and the suburbs around it</h2>
      <p>Ozghan is based in Brisbane and currently takes on tiling works across the greater Brisbane area — from the CBD and inner-city suburbs out through the surrounding residential areas. Brisbane's mix of older Queenslanders and newer builds means every project gets assessed for its own substrate and drainage before we quote.</p>
...
<section class="section-alt">
  <div class="container">
    <div class="section-head">
      <div class="eyebrow">Suburbs we cover</div>
      <h2>Brisbane areas we currently service</h2>
    </div>
    @if(isset($serviceAreas) && $serviceAreas->isNotEmpty())
    <ul class="suburb-list">
      @foreach($serviceAreas as $area)
      <li><span class="icon-inline">&#9678;</span>{{ $area->name }}@if($area->postcode) <small>{{ $area->postcode }}</small>@endif</li>
      @endforeach
    </ul>
    @else
    <ul class="suburb-list">
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Brisbane CBD</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>South Bank</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Fortitude Valley</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>New Farm</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Paddington</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>West End</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Toowong</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Indooroopilly</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Chermside</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Carindale</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Sherwood</li>
      <li><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.5 7-11.5A7 7 0 0 0 5 9.5C5 14.5 12 21 12 21z"/><circle cx="12" cy="9.5" r="2.3"/></svg></span>Ascot</li>
    </ul>
    @endif
  </div>
</section>
...
<section class="cta-banner">
  <div class="container cta-banner-inner">
    <div>
      <h2>In the Brisbane area?</h2>
      <p>Request a quote and add your address — we'll confirm we cover it.</p>
    </div>
