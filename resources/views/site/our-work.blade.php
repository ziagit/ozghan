...
.page-header p{ max-width:68ch; margin:16px 0 0; color:var(--bg); font-size:1.05rem; }
...
.gallery-card{ display:block; color:inherit; background:var(--white); border:1px solid var(--line); overflow:hidden; }
.gallery-swatch{
  position:relative;
  aspect-ratio:4/3;
...
<header class="site-header">
  <div class="container nav">
    ...
    <nav class="nav-links" aria-label="Primary">
      ...
      <a href="/our-work" data-nav="work" aria-current="page">Our Work</a>
...
<header class="page-header">
  <div class="container">
    ...
    <h1>Recent tiling works across Brisbane</h1>
