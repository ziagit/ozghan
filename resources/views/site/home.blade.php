...
<div class="trust-strip">
  <div class="container trust-grid">
    <div class="trust-item">
      <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z"/><path d="M9 12l2 2 4-4"/></svg></span>
      <h4>Licensed &amp; insured</h4>
      <p>Fully licensed Brisbane tilers with public liability cover on every tiling project.</p>
    </div>
    <div class="trust-item">
      <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="10.5" cy="10.5" r="6.5"/><path d="M15.5 15.5L21 21"/></svg></span>
      <h4>Free on-site quotes</h4>
      <p>We measure and scope in person before you commit to anything.</p>
    </div>
    <div class="trust-item">
      <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3s6 6.5 6 11a6 6 0 0 1-12 0c0-4.5 6-11 6-11z"/></svg></span>
      <h4>Waterproofing certified</h4>
      <p>Every wet area membrane installed to Australian Standard AS 3740.</p>
    </div>
    <div class="trust-item">
      <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="4.5" width="17" height="16" rx="2"/><path d="M3.5 9.5h17"/><path d="M8 3v3M16 3v3"/><path d="M8.5 14l2 2 4.5-4.5"/></svg></span>
      <h4>Fixed-date finish</h4>
      <p>Scheduled start and finish dates, confirmed before we begin.</p>
    </div>
  </div>
</div>
...
<section>
  <div class="container">
    ...
    <div class="grid-services">
      <div class="service-card">
        <div class="service-image svc-1" aria-hidden="true"></div>
      ...
      <div class="service-card">
        <div class="service-image svc-2" aria-hidden="true"></div>
        <div class="service-body">
      ...
      <div class="service-card">
        <div class="service-image svc-4" aria-hidden="true"></div>
        <div class="service-body">
          <h3>Floor Tiling</h3>
      ...
      <div class="service-card">
        <div class="service-image svc-6" aria-hidden="true"></div>
        <div class="service-body">
          <h3>Waterproofing</h3>
  ...
  <div class="container">
    <div class="work-head">
      <div class="section-head">
        ...
        <h2>Recent tiling work across Brisbane</h2>
      </div>
      <a class="btn btn-outline" href="/our-work">See more &rarr;</a>
    </div>
    ...
    <div class="work-row">
      ...
      <a class="work-thumb svc-{{ ($loop->index % 9) + 1 }}" href="/our-work" aria-label="{{ $work->category ?: 'Tiling project' }}">
        @if($work->image_path)
        <img loading="lazy" src="{{ \Illuminate\Support\Str::startsWith($work->image_path, ['services/', 'works/']) ? '/storage/'.ltrim($work->image_path, '/') : (\Illuminate\Support\Str::startsWith($work->image_path, ['http://', 'https://']) ? $work->image_path : asset(ltrim($work->image_path, '/'))) }}" alt="{{ $work->category ?: 'Tiling project' }}">
        @endif
      </a>
      @endforeach
    </div>
...
<section class="cta-banner">
  <div class="container cta-banner-inner">
    <div>
      <h2>Ready to get your tiling quoted?</h2>
      <p>Tell us the service, the address and a date — we'll take it from there.</p>
    </div>
