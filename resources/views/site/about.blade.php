...
<title>About | Ozghan.com.au Brisbane Tiling</title>
...
@include('site.partials.seo', ['seoTitle' => 'About Ozghan.com.au | Brisbane Tiling', 'seoDescription' => 'Learn about Ozghan, a Brisbane tiling company focused on precision, reliability and craftsmanship.'])
...
<section>
  <div class="container two-col">
    <div>
      ...
      <p>Ozghan was started in Brisbane to do one thing well: tiling work that is prepped, waterproofed and set correctly the first time. No shortcuts on the membrane, no rushed grout lines, no gaps between what was quoted and what was delivered.</p>
      <p>We work directly with homeowners, renovators and builders across Brisbane — from a single ensuite to a full commercial fit-out — and we're on site for the work ourselves, not managing it from a distance.</p>
      <div class="stat-row">
    ...
    <img class="service-image" loading="lazy" decoding="async" src="{{ $aboutImageUrl ?? '/images/about-us.avif' }}" alt="Ozghan tiling team at work in Brisbane" style="width:100%; aspect-ratio:1/1; object-fit:cover;">
  </div>
</section>
...
<section class="section-alt">
  <div class="container">
    <div class="section-head">
      ...
      <h2>Three things every project gets</h2>
    </div>
