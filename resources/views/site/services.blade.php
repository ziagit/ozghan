...
<title>Services | Ozghan.com.au Brisbane Tiling</title>
...
@include('site.partials.seo', ['seoTitle' => 'Tiling Services Brisbane | Ozghan.com.au', 'seoDescription' => 'Bathroom, kitchen, floor, wall, indoor, outdoor, waterproofing, renovation and commercial tiling services in Brisbane.'])
...
.eyebrow-icon .icon-inline{ width:24px; height:24px; }
...
<header class="site-header">
  <div class="container nav">
    ...
    <nav class="nav-links" aria-label="Primary">
      ...
      <a href="/services" data-nav="services" aria-current="page">Services</a>
...
<section class="{{ $loop->even ? 'section-alt' : '' }}" id="{{ $service->slug }}">
  <div class="container two-col">
    <div>
      <div class="eyebrow">{{ $service->category ?: 'Tiling' }}</div>
      <h2>{{ $service->title }}</h2>
...
<section id="bathroom-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 9V6a5 5 0 0 1 10 0"/><path d="M4 9h16"/><path d="M8 13v1M12 13v1M16 13v1M8 17v1M12 17v1M16 17v1"/></svg></span>Wet areas</div>
      <h2>Bathroom Tiling</h2>
      <p>Full wet-area tiling for bathrooms and ensuites — shower recesses, floors and walls — with certified waterproofing membrane installed underneath every tile, not just around the shower base.</p>
      <button class="btn btn-primary" data-open-quote data-service="Bathroom Tiling">Get a Quote for This</button>
    </div>
    <div class="service-image svc-1 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>

<div class="grout-rule"></div>

<section class="section-alt" id="kitchen-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2s-5 5.5-5 10a5 5 0 0 0 10 0c0-2-1-3.5-2-4.5.2 1.8-1 2.5-1 2.5.6-3-2-4-2-8z"/></svg></span>Kitchens</div>
      <h2>Kitchen Tiling</h2>
      <p>Splashbacks, benchtop returns and kitchen floors, tiled to handle daily heat, spills and wear without the finish breaking down over time.</p>
      <button class="btn btn-primary" data-open-quote data-service="Kitchen Tiling">Get a Quote for This</button>
    </div>
    <div class="service-image svc-2 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>

<div class="grout-rule"></div>

<section id="outdoor-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5 5l1.5 1.5M17.5 17.5L19 19M19 5l-1.5 1.5M6.5 17.5L5 19"/></svg></span>Outdoor</div>
      <h2>Outdoor Tiling</h2>
      <p>Slip-rated tiles for patios, alfresco areas, pool surrounds and entryways — laid with proper falls to shed water during Brisbane's storm season.</p>
      <button class="btn btn-primary" data-open-quote data-service="Outdoor Tiling">Get a Quote for This</button>
    </div>
    <div class="service-image svc-3 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>

<div class="grout-rule"></div>

<section class="section-alt" id="indoor-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5L12 4l8 7.5"/><path d="M6 10v9a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-9"/></svg></span>Indoor</div>
      <h2>Indoor Tiling</h2>
      <p>Living areas, hallways and laundries tiled flat and level, with expansion joints placed correctly so floors stay draught-free and crack-free.</p>
      <button class="btn btn-primary" data-open-quote data-service="Indoor Tiling">Get a Quote for This</button>
    </div>
...
<section id="floor-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5"/></svg></span>Floors</div>
      <h2>Floor Tiling</h2>
      <p>Precision floor tiling across any room, with tiles matched for pattern, batch and colour, and grout lines kept consistent from wall to wall.</p>
      <button class="btn btn-primary" data-open-quote data-service="Floor Tiling">Get a Quote for This</button>
    </div>
...
<section class="section-alt" id="wall-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="1"/><path d="M4 10h16M4 16h16M10 4v16M16 4v16"/></svg></span>Walls</div>
      <h2>Wall Tiling</h2>
      <p>Feature walls and full wall coverage, set plumb and true from the first row to the last, with cuts hidden in the least visible corner.</p>
      <button class="btn btn-primary" data-open-quote data-service="Wall Tiling">Get a Quote for This</button>
    </div>
    <div class="service-image svc-6 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>
...
<section id="waterproofing">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z"/><path d="M12 8c1.2 1.6 2 2.8 2 4a2 2 0 1 1-4 0c0-1.2.8-2.4 2-4z"/></svg></span>Wet-area prep</div>
      <h2>Waterproofing</h2>
      <p>Membrane waterproofing to Australian Standard AS 3740, applied to floors, walls and hobs before a single tile goes down — with a compliance certificate on completion.</p>
      <button class="btn btn-primary" data-open-quote data-service="Waterproofing">Get a Quote for This</button>
    </div>
    <div class="service-image svc-7 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>

<div class="grout-rule"></div>

<section class="section-alt" id="renovation-tiling">
  <div class="container two-col">
    <div>
      <div class="eyebrow eyebrow-icon"><span class="icon-inline"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 3.5l6 6-2 2-6-6z"/><path d="M13 6L4.5 14.5a2 2 0 0 0 0 2.8l.2.2a2 2 0 0 0 2.8 0L16 9"/></svg></span>Renovations</div>
      <h2>Renovation Tiling</h2>
      <p>Strip-outs, substrate repair and re-tiling for bathroom and kitchen renovations of any scale — including making good after old tile and membrane removal.</p>
      <button class="btn btn-primary" data-open-quote data-service="Renovation Tiling">Get a Quote for This</button>
    </div>
    <div class="service-image svc-8 rounded-media" aria-hidden="true" style="aspect-ratio:4/3;"></div>
  </div>
</section>
